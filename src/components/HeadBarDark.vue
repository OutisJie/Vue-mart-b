...
<div class="headerDark" >
  <div class="sitetitle" style="padding-top:18px; margin-left: 10px; float:left;">基于人工智能的软件外包服务平台</div>

  <el-menu class="el-menu" theme="dark" mode="horizontal" style="padding-top:0px; margin-left:300px">
    ...
    <el-dropdown class="el-dropdown">
      ...
      <el-dropdown-menu slot="dropdown" style="background: #324157; color: #EEF1F5">
        <el-dropdown-item>个人中心</el-dropdown-item>
        <el-dropdown-item>我的项目</el-dropdown-item>
        <el-dropdown-item>我的报价单</el-dropdown-item>
